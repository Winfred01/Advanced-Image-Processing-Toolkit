...
public class ImageFilter{
	...
	public static void blur (int[] imageData, int width, double sigma){
		...
		// Arrays to store the intermediate results of the blur
	...
	// Helper method to get the pixel data at a specific location in the image array
	...
	// Helper method to set the pixel data at a specific location in the image array
	...
	public static void edgeDetection(int[] imageData, int width) {
		...
		// Apply threshold to the edge data to create the final edge-detected image
